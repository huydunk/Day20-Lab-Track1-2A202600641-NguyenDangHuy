...
| Retention metric đã chọn | **Headline — Trip-to-trip retention (đường cong @30/60/90 ngày):** % user quay lại lập/chấp nhận một chuyến **kế tiếp** đo tại mốc 30, 60, 90 ngày — phản ánh **hình dạng quay lại** quanh khoảng cách chuyến tự nhiên ~6.5–10.5 tuần (nhịp 5–8 chuyến/năm), thay vì một mốc cắt duy nhất. **Hỗ trợ (engagement) — MAU + monthly cohort retention + stickiness** trong mùa có chuyến (khớp active-user 30 ngày). ❌ **Không** dùng D1/D7 daily retention làm thước đo chính. |
